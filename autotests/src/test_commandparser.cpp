...
// 测试 process 方法解析参数
TEST_F(CommandParserTest, ProcessArguments)
{
...
TEST_F(CommandParserTest, IsSetOptionNotSet)
{
    CommandParser *parser = CommandParser::instance();
...
// 测试 value 方法获取选项值
TEST_F(CommandParserTest, ValueOfOption)
{
    CommandParser *parser = CommandParser::instance();
...
static QStringList CommandParserTest_stub_appArguments()
{
...
static void CommandParserTest_stub_showPrintDialog(PrintHelper *,
                                                  const QStringList &,
                                                  QWidget *)
{
}
...
TEST_F(CommandParserTest, ProcessNoArgs_UsesAppArguments_ParsesPositional)
{
    Stub stub;
    stub.set(&QCoreApplication::arguments, CommandParserTest_stub_appArguments);
...
TEST_F(CommandParserTest, QuickPrint_NoPositional_ReturnsEarly)
{
    CommandParser *parser = CommandParser::instance();
...
TEST_F(CommandParserTest, QuickPrint_WithPositional_CallsPrintDialog)
{
    CommandParser *parser = CommandParser::instance();
    ...
    stub.set(ADDR(PrintHelper, showPrintDialog),
             CommandParserTest_stub_showPrintDialog);
...
TEST_F(CommandParserTest, IsSet_SetOption_ReturnsTrue)
{
    CommandParser *parser = CommandParser::instance();
...
TEST_F(CommandParserTest, Value_SetFlagOption_ReturnsEmpty)
{
    CommandParser *parser = CommandParser::instance();
...
TEST_F(CommandParserTest, AddOption_CustomOption_BecomesRecognized)
{
    CommandParser *parser = CommandParser::instance();
