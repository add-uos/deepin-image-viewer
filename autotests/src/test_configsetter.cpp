...
void LibConfigSetterTest::SetUp()
{
}

void LibConfigSetterTest::TearDown()
{
}

// 测试单例实例获取
TEST_F(LibConfigSetterTest, Instance)
{
...
// 测试设置和读取配置值
TEST_F(LibConfigSetterTest, SetValueAndGetValue)
{
...
// 测试读取不存在的键返回默认值
TEST_F(LibConfigSetterTest, GetValueWithDefault)
{
    LibConfigSetter *setter = LibConfigSetter::instance();
...
// 测试 valueChanged 信号
TEST_F(LibConfigSetterTest, ValueChangedSignal)
{
    LibConfigSetter *setter = LibConfigSetter::instance();
...
TEST_F(LibConfigSetterTest, PrivateConstructorDestructor_RunsClean)
{
...
// 测试设置并读取整型值
TEST_F(LibConfigSetterTest, SetValue_IntType_RoundTrips)
{
    LibConfigSetter *setter = LibConfigSetter::instance();
...
TEST_F(LibConfigSetterTest, Value_NonexistentKeyNoDefault_ReturnsInvalid)
{
    LibConfigSetter *setter = LibConfigSetter::instance();
...
TEST_F(LibConfigSetterTest, ValueChangedSignal_CarriesCorrectParameters)
{
    LibConfigSetter *setter = LibConfigSetter::instance();
