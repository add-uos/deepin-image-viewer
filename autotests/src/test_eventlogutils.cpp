...
void EventlogutilsTest::SetUp() {}
void EventlogutilsTest::TearDown() {}

// 测试 GetInstance 返回非空单例
TEST_F(EventlogutilsTest, GetInstance_ReturnsNonNull)
{
...
TEST_F(EventlogutilsTest, GetInstance_ReturnsSameSingleton)
{
...
TEST_F(EventlogutilsTest, WriteLogs_WithNullFuncPtr_NoCrash)
{
    Eventlogutils *inst = Eventlogutils::GetInstance();
...
TEST_F(EventlogutilsTest, WriteLogs_WithFuncPtrSet_FuncCalled)
{
    Eventlogutils *inst = Eventlogutils::GetInstance();
...
TEST_F(EventlogutilsTest, WriteLogs_EmptyJson_NoCrash)
{
    Eventlogutils *inst = Eventlogutils::GetInstance();
    QJsonObject empty;
