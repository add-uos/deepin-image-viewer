...
void GlobalControlTest::SetUp()
{
}

void GlobalControlTest::TearDown()
{
}

// 测试构造与析构
TEST_F(GlobalControlTest, Construct)
{
...
// 测试默认索引值
TEST_F(GlobalControlTest, DefaultIndex)
{
...
// 测试设置图片文件列表
TEST_F(GlobalControlTest, SetImageFiles)
{
...
// 测试设置当前索引
TEST_F(GlobalControlTest, CurrentIndex)
{
    QTemporaryDir tmpDir;
    ASSERT_TRUE(tmpDir.isValid());
...
// 测试旋转角度设置
TEST_F(GlobalControlTest, CurrentRotation)
{
    GlobalControl control;
...
TEST_F(GlobalControlTest, Models_ReturnValidInstances)
{
    GlobalControl control;
...
TEST_F(GlobalControlTest, CurrentSource_SetSourceInModel_UpdatesIndex)
{
    QTemporaryDir tmpDir;
    ASSERT_TRUE(tmpDir.isValid());
    GlobalControl control;
...
TEST_F(GlobalControlTest, SetCurrentFrameIndex_SingleFrame_ClampedToZero)
{
    QTemporaryDir tmpDir;
    ASSERT_TRUE(tmpDir.isValid());
    GlobalControl control;
...
TEST_F(GlobalControlTest, SetIndexAndFrameIndex_UpdatesIndex)
{
    QTemporaryDir tmpDir;
    ASSERT_TRUE(tmpDir.isValid());
    GlobalControl control;
...
TEST_F(GlobalControlTest, HasPreviousNext_AtMiddle_BothTrue)
{
    QTemporaryDir tmpDir;
    ASSERT_TRUE(tmpDir.isValid());
    GlobalControl control;
...
TEST_F(GlobalControlTest, PreviousAndNext_NavigateSuccessfully)
{
    QTemporaryDir tmpDir;
    ASSERT_TRUE(tmpDir.isValid());
    GlobalControl control;
...
TEST_F(GlobalControlTest, FirstAndLast_NavigateSuccessfully)
{
    QTemporaryDir tmpDir;
    ASSERT_TRUE(tmpDir.isValid());
    GlobalControl control;
...
TEST_F(GlobalControlTest, FirstAndLast_EmptyModel_ReturnsFalse)
{
    GlobalControl control;
...
TEST_F(GlobalControlTest, AddImageAndSetCurrentSource_NewImage_Adds)
{
    QTemporaryDir tmpDir;
    ASSERT_TRUE(tmpDir.isValid());
    GlobalControl control;
...
TEST_F(GlobalControlTest, AddImageAndSetCurrentSource_InvalidUrl_ReturnsFalse)
{
    GlobalControl control;
...
TEST_F(GlobalControlTest, RemoveImage_Current_RemovesAndUpdates)
{
    QTemporaryDir tmpDir;
    ASSERT_TRUE(tmpDir.isValid());
    GlobalControl control;
...
TEST_F(GlobalControlTest, RenameImage_CurrentSource_Updates)
{
    QTemporaryDir tmpDir;
    ASSERT_TRUE(tmpDir.isValid());
    GlobalControl control;
...
TEST_F(GlobalControlTest, SubmitImageChangeImmediately_NoRotation_NoOp)
{
    GlobalControl control;
...
TEST_F(GlobalControlTest, SubmitImageChangeImmediately_WithRotation_EmitsRequest)
{
    QTemporaryDir tmpDir;
    ASSERT_TRUE(tmpDir.isValid());
    GlobalControl control;
...
TEST_F(GlobalControlTest, EnableMultiThread_ReturnsBool)
{
...
TEST_F(GlobalControlTest, TimerEvent_SubmitTimer_TriggersSubmit)
{
    GlobalControl control;
...
TEST_F(GlobalControlTest, TimerEvent_SwitchCheckTimer_TriggersCheck)
{
    GlobalControl control;
...
TEST_F(GlobalControlTest, TimerEvent_UnknownTimerId_NoOp)
{
    GlobalControl control;
    QTimerEvent ev(-999);
    control.timerEvent(&ev);
...
TEST_F(GlobalControlTest, CheckSwitchEnable_EmptyModel_AllDisabled)
{
    GlobalControl control;
