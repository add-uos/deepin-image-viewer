...
void GlobalStatusTest::SetUp()
{
}

void GlobalStatusTest::TearDown()
{
}

// 测试常量属性返回值
TEST_F(GlobalStatusTest, ConstantProperties)
{
    GlobalStatus status;
...
TEST_F(GlobalStatusTest, ShowFullScreenProperty)
{
    GlobalStatus status;
...
TEST_F(GlobalStatusTest, EnableNavigationProperty)
{
    GlobalStatus status;
...
// 测试 stackPage 属性设置
TEST_F(GlobalStatusTest, StackPageProperty)
{
    GlobalStatus status;
...
TEST_F(GlobalStatusTest, ThumbnailVaildWidthProperty)
{
    GlobalStatus status;
...
// 测试 delayInit 属性设置
TEST_F(GlobalStatusTest, DelayInitProperty)
{
    GlobalStatus status;
...
TEST_F(GlobalStatusTest, ShowRightMenuProperty)
{
    GlobalStatus status;
...
TEST_F(GlobalStatusTest, ShowImageInfoProperty)
{
    GlobalStatus status;
...
TEST_F(GlobalStatusTest, ViewInteractiveProperty)
{
    GlobalStatus status;
...
TEST_F(GlobalStatusTest, ViewFlickingProperty)
{
    GlobalStatus status;
...
TEST_F(GlobalStatusTest, AnimationBlockProperty)
{
    GlobalStatus status;
...
TEST_F(GlobalStatusTest, FullScreenAnimatingProperty)
{
    GlobalStatus status;
...
TEST_F(GlobalStatusTest, Destructor_DeletingDestructor)
{
