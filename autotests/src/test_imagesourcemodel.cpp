...
void ImageSourceModelTest::SetUp()
{
}

void ImageSourceModelTest::TearDown()
{
}

// 测试默认构造与空模型
TEST_F(ImageSourceModelTest, DefaultConstruct)
{
...
TEST_F(ImageSourceModelTest, RoleNames)
{
    ImageSourceModel model;
...
TEST_F(ImageSourceModelTest, SetImageFilesAndUpdateRowCount)
{
    ImageSourceModel model;
    QList<QUrl> files;
...
// 测试 data 传入非法索引返回空
TEST_F(ImageSourceModelTest, DataInvalidIndexReturnsEmpty)
{
    ImageSourceModel model;
    QList<QUrl> files;
...
TEST_F(ImageSourceModelTest, DataUnknownRoleReturnsEmpty)
{
    ImageSourceModel model;
    QList<QUrl> files;
    files << QUrl("file:///a.jpg");
...
// 测试 setData 成功并发信号
TEST_F(ImageSourceModelTest, SetDataValidEmitsSignal)
{
    ImageSourceModel model;
    QList<QUrl> files;
...
TEST_F(ImageSourceModelTest, SetDataInvalidIndexReturnsFalse)
{
    ImageSourceModel model;
...
TEST_F(ImageSourceModelTest, SetDataUnknownRoleReturnsFalse)
{
    ImageSourceModel model;
    QList<QUrl> files;
    files << QUrl("file:///a.jpg");
...
TEST_F(ImageSourceModelTest, IndexForImagePath)
{
    ImageSourceModel model;
    QList<QUrl> files;
    files << QUrl("file:///a.jpg") << QUrl("file:///b.jpg");
...
TEST_F(ImageSourceModelTest, RemoveExistingImage)
{
    ImageSourceModel model;
    QList<QUrl> files;
    files << QUrl("file:///a.jpg") << QUrl("file:///b.jpg") << QUrl("file:///c.jpg");
...
TEST_F(ImageSourceModelTest, RemoveNonexistingImage)
{
    ImageSourceModel model;
    QList<QUrl> files;
    files << QUrl("file:///a.jpg");
...
// 测试 rowCount 带父索引参数
TEST_F(ImageSourceModelTest, RowCountWithParent)
{
    ImageSourceModel model;
    QList<QUrl> files;
    files << QUrl("file:///a.jpg") << QUrl("file:///b.jpg");
