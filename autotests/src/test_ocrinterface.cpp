...
void OcrInterfaceTest::SetUp() {}
void OcrInterfaceTest::TearDown() {}

// ==================== staticInterfaceName ====================

TEST_F(OcrInterfaceTest, StaticInterfaceName_ReturnsComDeepinOcr)
{
...
TEST_F(OcrInterfaceTest, Construct_SetsServicePathInterface)
{
...
TEST_F(OcrInterfaceTest, Construct_PublicDbusMemberIsSessionBus)
{
    OcrInterface iface("com.deepin.Ocr.Fake",
                       "/com/deepin/Ocr/Fake",
                       QDBusConnection::sessionBus());
...
// 构造：使用 systemBus 不崩溃
TEST_F(OcrInterfaceTest, Construct_WithSystemBus_NoCrash)
{
    OcrInterface iface("com.deepin.Ocr.Fake",
                       "/com/deepin/Ocr/Fake",
...
TEST_F(OcrInterfaceTest, Destruct_DoesNotCrash)
{
...
TEST_F(OcrInterfaceTest, OpenFile_ReturnsPendingReply_NoCrash)
{
    Stub stub;
...
TEST_F(OcrInterfaceTest, OpenImage_ValidImage_NoCrash)
{
    Stub stub;
    stub.set(ADDR(QDBusAbstractInterface, doCall), ut_ocr_stub_doCall);
    OcrInterface iface("com.deepin.Ocr.Fake",
...
TEST_F(OcrInterfaceTest, OpenImage_NullImage_NoCrash)
{
    Stub stub;
    stub.set(ADDR(QDBusAbstractInterface, doCall), ut_ocr_stub_doCall);
    OcrInterface iface("com.deepin.Ocr.Fake",
...
TEST_F(OcrInterfaceTest, OpenImageAndName_ValidImageAndName_NoCrash)
{
    Stub stub;
    stub.set(ADDR(QDBusAbstractInterface, doCall), ut_ocr_stub_doCall);
    OcrInterface iface("com.deepin.Ocr.Fake",
...
TEST_F(OcrInterfaceTest, OpenImageAndName_NullImage_NoCrash)
{
    Stub stub;
    stub.set(ADDR(QDBusAbstractInterface, doCall), ut_ocr_stub_doCall);
    OcrInterface iface("com.deepin.Ocr.Fake",
