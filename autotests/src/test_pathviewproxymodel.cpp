...
void PathViewProxyModelTest::SetUp()
{
    ensurePathViewTempImages();
}

void PathViewProxyModelTest::TearDown()
{
}

// 测试构造与默认状态
TEST_F(PathViewProxyModelTest, Construct)
{
...
// 测试 roleNames
TEST_F(PathViewProxyModelTest, RoleNames)
{
    ImageSourceModel src;
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, SetCurrentIndexAndSignal)
{
    ImageSourceModel src;
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, SetQueueCountValid)
{
    ImageSourceModel src;
    PathViewProxyModel model(&src);
...
// 测试 resetModel 填充队列
TEST_F(PathViewProxyModelTest, ResetModelFillsQueue)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
// 测试 data 合法与非法索引
TEST_F(PathViewProxyModelTest, DataValidAndInvalid)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
// 测试 setData 更新 url
TEST_F(PathViewProxyModelTest, SetDataUpdatesUrl)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, SetDataInvalidAndUnknownRole)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, MoveNextAndPrevious)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
// 测试 dumpInfo 不崩溃
TEST_F(PathViewProxyModelTest, DumpInfo)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, SyncStateNoOpWhenCurrent)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, SyncStateAfterJump)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, SetCurrentSourceIndexBranches)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, SetCurrentSourceIndexEmptyQueue)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, DeleteCurrentBranches)
{
    // 1. 空队列
    {
        ImageSourceModel src;
...
// 测试 sourcePath 合法与越界
TEST_F(PathViewProxyModelTest, PrivateSourcePath)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, PrivateProxyIdxRing)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
// 测试 distance 各分支
TEST_F(PathViewProxyModelTest, PrivateDistance)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, PrivateInfoFromIndex)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, PrivateCreatePrevNextIndexInfo)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, PrivateCreatePrevAtBoundary)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, PrivateUpdateIndexInfo)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, PrivateJumpAndRefresh)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
TEST_F(PathViewProxyModelTest, PrivateAsyncUpdateLoadInfo)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
...
// IndexInfo 拷贝构造函数
TEST_F(PathViewProxyModelTest, IndexInfoCopyConstructor)
{
    ImageSourceModel src;
    src.setImageFiles(g_pathviewTmpUrls);
    PathViewProxyModel model(&src);
