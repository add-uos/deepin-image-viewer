...
static int PrintHelperTest_stub_exec(DDialog *)
{
    return 0;
}

static void PrintHelperTest_install_exec_stub(Stub &stub)
{
    void *addr = dlsym(RTLD_DEFAULT, "_ZN3Dtk6Widget7DDialog4execEv");
    ASSERT_TRUE(addr != nullptr);
    stub.set(addr, PrintHelperTest_stub_exec);
}

void PrintHelperTest::SetUp() {}
void PrintHelperTest::TearDown() {}

// ==================== RequestedSlot ====================

// 测试构造函数初始化成员为空
TEST_F(PrintHelperTest, RequestedSlot_Construct_InitializesEmptyMembers)
{
    RequestedSlot slot;
...
// 测试析构函数不崩溃
TEST_F(PrintHelperTest, RequestedSlot_Destruct_DoesNotCrash)
{
...
TEST_F(PrintHelperTest, RequestedSlot_PublicMembers_ReadWrite)
{
    RequestedSlot slot;
...
TEST_F(PrintHelperTest, RequestedSlot_PaintRequestSync_EmptyImgs_NoCrash)
{
    RequestedSlot slot;
    DPrinter printer;
...
TEST_F(PrintHelperTest, RequestedSlot_PaintRequestSync_SingleValidImage)
{
    RequestedSlot slot;
...
TEST_F(PrintHelperTest, RequestedSlot_PaintRequestSync_NullImageSkipped)
{
    RequestedSlot slot;
    QImage nullImg;  // null
...
TEST_F(PrintHelperTest, RequestedSlot_PaintRequestSync_MultipleImages_NewPage)
{
    RequestedSlot slot;
...
TEST_F(PrintHelperTest, RequestedSlot_PaintRequestSync_WideImage_FitWidth)
{
    RequestedSlot slot;
...
TEST_F(PrintHelperTest, PrintHelper_GetIntance_ReturnsSingleton)
{
...
TEST_F(PrintHelperTest, PrintHelper_Instance_HasRequestedSlotMember)
{
...
TEST_F(PrintHelperTest, PrintHelper_PrivateConstructor_CreatesRequestedSlot)
{
...
TEST_F(PrintHelperTest, PrintHelper_ShowPrintDialog_EmptyPaths_ClearsState)
{
    PrintHelper *p = PrintHelper::getIntance();
    Stub stub;
    PrintHelperTest_install_exec_stub(stub);
...
TEST_F(PrintHelperTest, PrintHelper_ShowPrintDialog_NonexistentPath_NoCrash)
{
    PrintHelper *p = PrintHelper::getIntance();
    Stub stub;
    PrintHelperTest_install_exec_stub(stub);
    QStringList paths;
    paths << "/tmp/PrintHelperTest_nonexistent_12345.png";
...
TEST_F(PrintHelperTest, PrintHelper_ShowPrintDialog_ValidImage_LoadsAndClears)
{
    // 生成临时 PNG 文件
    QString tmpPath = QString("/tmp/PrintHelperTest_%1.png").arg(QCoreApplication::instance()->applicationPid());
...
TEST_F(PrintHelperTest, PrintHelper_ShowPrintDialog_MultiplePaths_NoCrash)
{
    QString tmpPath = QString("/tmp/PrintHelperTest_multi_%1.jpg").arg(QCoreApplication::instance()->applicationPid());
    ...
    PrintHelperTest_install_exec_stub(stub);
    QStringList paths;
    paths << tmpPath << "/tmp/PrintHelperTest_missing.png";
    p->showPrintDialog(paths, nullptr);
    EXPECT_TRUE(p->m_re->m_paths.isEmpty());
