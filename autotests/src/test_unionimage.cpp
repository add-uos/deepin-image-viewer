...
void UnionImageTest::SetUp() {}
void UnionImageTest::TearDown() {}

// ---------------- unionImageVersion ----------------
TEST_F(UnionImageTest, UnionImageVersion_WhenCalled_ReturnsNonEmptyVersionString)
{
...
TEST_F(UnionImageTest, UnionImageSupportFormat_WhenCalled_ReturnsNonEmptyListContainingCommonFormats)
{
...
// ---------------- supportStaticFormat ----------------
TEST_F(UnionImageTest, SupportStaticFormat_WhenCalled_ReturnsSameListAsSupportFormat)
{
...
// ---------------- supportMovieFormat ----------------
TEST_F(UnionImageTest, SupportMovieFormat_WhenCalled_ReturnsListMaybeEmpty)
{
...
// ---------------- creatNewImage ----------------
TEST_F(UnionImageTest, CreatNewImage_WhenDepthIs8_CreatesRgb888Image)
{
    QImage img;
...
TEST_F(UnionImageTest, CreatNewImage_WhenDepthIs16_CreatesRgb16Image)
{
    QImage img;
...
TEST_F(UnionImageTest, CreatNewImage_WhenDepthIsOther_CreatesRgb32Image)
{
    QImage img;
...
TEST_F(UnionImageTest, CreatNewImage_WhenWidthHeightZero_CreatesNullImage)
{
    QImage img;
    // QImage(0,0,...) 构造为空图
...
// ---------------- isNoneQImage ----------------
TEST_F(UnionImageTest, IsNoneQImage_WhenImageIsDefaultConstructed_ReturnsTrue)
{
    QImage img;  // 默认构造为 null,与 noneQImage()(同样为 null)相等
    EXPECT_TRUE(isNoneQImage(img));
}

TEST_F(UnionImageTest, IsNoneQImage_WhenImageIsValid_ReturnsFalse)
{
...
// ---------------- rotateImage ----------------
TEST_F(UnionImageTest, RotateImage_WhenAngleNotMultipleOf90_ReturnsFalse)
{
    QImage img(2, 2, QImage::Format_RGB32);
    QImage original = img;
...
TEST_F(UnionImageTest, RotateImage_WhenImageIsNull_ReturnsFalse)
{
    QImage img;
    EXPECT_FALSE(rotateImage(90, img));
}

TEST_F(UnionImageTest, RotateImage_WhenRotate90_SwapsWidthAndHeight)
{
...
TEST_F(UnionImageTest, RotateImage_WhenRotate180_KeepsDimensions)
{
    QImage img(4, 2, QImage::Format_RGB32);
...
// ---------------- detectImageFormat ----------------
TEST_F(UnionImageTest, DetectImageFormat_WhenFileCannotOpen_ReturnsEmpty)
{
    EXPECT_EQ(detectImageFormat("/nonexistent/path/file.xyz"), QString(""));
}

TEST_F(UnionImageTest, DetectImageFormat_WhenPngHeader_ReturnsPNG)
{
    QTemporaryFile tmp;
    tmp.open();
    // PNG 文件头
...
TEST_F(UnionImageTest, DetectImageFormat_WhenJpgHeader_ReturnsJPG)
{
    QTemporaryFile tmp;
    tmp.open();
...
TEST_F(UnionImageTest, DetectImageFormat_WhenBmpHeader_ReturnsBMP)
{
    QTemporaryFile tmp;
    tmp.open();
    tmp.write("BM");
...
TEST_F(UnionImageTest, DetectImageFormat_WhenGifHeader_ReturnsGIF)
{
    QTemporaryFile tmp;
    tmp.open();
    tmp.write("GIF89a");
...
TEST_F(UnionImageTest, DetectImageFormat_WhenUnknownHeader_ReturnsSuffix)
{
...
TEST_F(UnionImageTest, LoadStaticImageFromFile_WhenFileEmpty_ReturnsFalse)
{
    QTemporaryFile tmp;
    tmp.open();  // 空文件,大小为 0
    tmp.close();
...
TEST_F(UnionImageTest, LoadStaticImageFromFile_WhenValidPng_ReturnsTrueAndLoadsImage)
{
    // 先准备一张有效的 PNG
...
TEST_F(UnionImageTest, LoadStaticImageFromFile_WhenUnsupportedFormat_ReturnsFalse)
{
...
// ---------------- rotateImageFile ----------------
TEST_F(UnionImageTest, RotateImageFile_WhenAngleNotMultipleOf90_ReturnsFalse)
{
    QString err;
...
TEST_F(UnionImageTest, RotateImageFile_WhenPng_RotatesAndSavesSuccessfully)
{
...
TEST_F(UnionImageTest, RotateImageFile_WhenTargetPathProvided_SavesToTarget)
{
    QImage src(4, 2, QImage::Format_RGB32);
    src.fill(Qt::green);
...
TEST_F(UnionImageTest, RotateImageFIleWithImage_WhenAngleNotMultipleOf90_ReturnsFalse)
{
    QImage img(2, 2, QImage::Format_RGB32);
    QString err;
...
TEST_F(UnionImageTest, RotateImageFIleWithImage_WhenImageIsNull_ReturnsFalse)
{
    QImage img;
    QString err;
...
TEST_F(UnionImageTest, RotateImageFIleWithImage_WhenUnsupportedFormat_ReturnsFalse)
{
    QImage img(2, 2, QImage::Format_RGB32);
    img.fill(Qt::red);
...
TEST_F(UnionImageTest, RotateImageFIleWithImage_WhenJpgFile_RotatesAndSaves)
{
    QImage src(4, 2, QImage::Format_RGB32);
    src.fill(Qt::blue);
...
// ---------------- getAllMetaData ----------------
TEST_F(UnionImageTest, GetAllMetaData_WhenValidPng_ReturnsPopulatedMap)
{
...
// ---------------- canSave ----------------
TEST_F(UnionImageTest, CanSave_WhenPng_ReturnsTrue)
{
    QImage src(2, 2, QImage::Format_RGB32);
    QTemporaryFile tmp("XXXXXX.PNG");
    tmp.open();
...
TEST_F(UnionImageTest, CanSave_WhenUnsupportedExt_ReturnsFalse)
{
...
TEST_F(UnionImageTest, IsImageSupportRotate_DelegatesToCanSave)
{
    QImage src(2, 2, QImage::Format_RGB32);
    QTemporaryFile tmp("XXXXXX.PNG");
    tmp.open();
...
// ---------------- getOrientation ----------------
TEST_F(UnionImageTest, GetOrientation_AlwaysReturnsOne)
{
    // 实现固定返回 1,忽略参数
...
// ---------------- getImageType ----------------
TEST_F(UnionImageTest, GetImageType_WhenEmptyPath_ReturnsBlank)
{
    EXPECT_EQ(getImageType(""), imageViewerSpace::ImageTypeBlank);
}

TEST_F(UnionImageTest, GetImageType_WhenFileNotExists_ReturnsBlank)
{
    EXPECT_EQ(getImageType("/nonexistent/file.png"), imageViewerSpace::ImageTypeBlank);
}

TEST_F(UnionImageTest, GetImageType_WhenValidPng_ReturnsStatic)
{
    QImage src(2, 2, QImage::Format_RGB32);
    QTemporaryFile tmp("XXXXXX.PNG");
    tmp.open();
...
// ---------------- getPathType ----------------
TEST_F(UnionImageTest, GetPathType_WhenLocalPath_ReturnsLOCAL)
{
    EXPECT_EQ(getPathType("/tmp/some_local_file.png"), imageViewerSpace::PathTypeLOCAL);
}

TEST_F(UnionImageTest, GetPathType_WhenSmbSharePath_ReturnsSMB)
{
    EXPECT_EQ(getPathType("smb-share:server=foo/path"), imageViewerSpace::PathTypeSMB);
}

TEST_F(UnionImageTest, GetPathType_WhenMtpPath_ReturnsMTP)
{
    EXPECT_EQ(getPathType("mtp:host=device/file"), imageViewerSpace::PathTypeMTP);
}

TEST_F(UnionImageTest, GetPathType_WhenGphoto2Path_ReturnsPTP)
{
    EXPECT_EQ(getPathType("gphoto2:host=device"), imageViewerSpace::PathTypePTP);
}

TEST_F(UnionImageTest, GetPathType_WhenTrashPath_ReturnsRecycleBin)
{
